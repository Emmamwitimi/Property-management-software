...
@app.route('/tenants/<int:id>', methods=['GET', 'PUT', 'PATCH', 'DELETE'])
def tenant_detail(id):
    tenant = get_object_or_404(Tenant, id)
...
@app.route('/landlords/<int:id>', methods=['GET', 'PUT', 'PATCH', 'DELETE'])
def landlord_detail(id):
    landlord = get_object_or_404(Landlord, id)
...
@app.route('/properties/<int:id>', methods=['GET', 'PUT', 'PATCH', 'DELETE'])
def property_detail(id):
    property_instance = get_object_or_404(Property, id)
